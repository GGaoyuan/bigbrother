...
if __name__ == '__main__':
    ...
    #     histories: DataFrame = result['history']
    #     print()
    #     yAxis.append(industry['板块名称'] + '\n' + industry['板块代码'])
    #     if len(xAxis) == 0:
    #         xAxis = histories['日期'].tolist()
    ...
    # rsp_value['xAxis'] = xAxis
    # rsp_value['yAxis'] = yAxis
    # rsp_value['data'] = data
    ...
    # data = dict()
    # data['title'] = 'im title'
    # data['minMapValue'] = 'minMapValue'
    # data['maxMapValue'] = 'maxMapValue'
    # data['xAxis'] = ['12a', '1a', '2a', '3a', '4a', '5a', '6a', '7a', '8a', '9a', '10a', '11a', '12p', '1p', '2p', '3p',
    #                  '4p', '5p', '6p', '7p', '8p', '9p', '10p', '11p']
    # data['yAxis'] = ['Saturday', 'Friday', 'Thursday', 'Wednesday', 'Tuesday', 'Monday', 'Sunday']
    # data['data'] = [
