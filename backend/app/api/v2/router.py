...
from app.api.v2.index_chart import router as index_chart_router
...
from app.api.v2.volume_profile import router as volume_profile_router

router = APIRouter(tags=["v2-desktop"])

router.include_router(fundation_router)
router.include_router(hotlist_router)
router.include_router(index_chart_router)
...
router.include_router(volume_profile_router)
